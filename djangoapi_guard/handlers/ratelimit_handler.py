...
from djangoapi_guard.scripts.rate_lua import RATE_LIMIT_SCRIPT
...
class RateLimitManager:
    ...
    def _handle_rate_limit_exceeded(
        ...
        client_ip: str,
        count: int,
        create_error_response: Callable[[int, str], HttpResponse],
        rate_limit_window: int | None = None,
    ) -> HttpResponse:
    ...
    def _send_rate_limit_event(
        self, request: HttpRequest, client_ip: str, request_count: int
    ) -> None:
        try:
